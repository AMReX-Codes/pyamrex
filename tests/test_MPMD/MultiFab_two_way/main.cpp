...
#endif
    {
        ...
        for(amrex::MFIter mfi(mf); mfi.isValid(); ++mfi){
            ...
            amrex::ParallelFor(bx, [=] AMREX_GPU_DEVICE(int i, int j, int k){
                ...
                // Let us only populate the first component on cpp side
        ...
        */
        ...
        // Send ONLY the FIRST populated MultiFab component to python side
        copr.send(mf,0,1);
        // Receive ONLY the SECOND MultiFab component from python side
        copr.recv(mf,1,1);
#endif
        //Plot MultiFab Data

...
class AmrInfo:
    ...
    def __repr__(self) -> str:
        ...
    def blocking_factor(self, arg0: int) -> IntVect3D:
        ...
    def max_grid_size(self, arg0: int) -> IntVect3D:
        ...
    def n_error_buf(self, arg0: int) -> IntVect3D:
        ...
    def ref_ratio(self, arg0: int) -> IntVect3D:
        ...
class AmrMesh:
    @typing.overload
    def __init__(self) -> None:
        ...
    @typing.overload
    def __init__(self, rb: RealBox, max_level_in: int, n_cell_in: Vector_int, coord: int, ref_ratios: Vector_IntVect, is_per: typing.Annotated[list[int], pybind11_stubgen.typing_ext.FixedSize(3)]) -> None:
        ...
    def __repr__(self) -> str:
        ...
    @typing.overload
...
class Array4_cdouble:
    @typing.overload
    def __getitem__(self, arg0: IntVect3D) -> complex:
        ...
    @typing.overload
    ...
    def contains(self, arg0: int, arg1: int, arg2: int) -> bool:
        ...
    @typing.overload
    def contains(self, arg0: IntVect3D) -> bool:
        ...
    @typing.overload
...
class Array4_double:
    @typing.overload
    def __getitem__(self, arg0: IntVect3D) -> float:
        ...
    @typing.overload
...
class Array4_int:
    @typing.overload
    def __getitem__(self, arg0: IntVect3D) -> int:
        ...
    @typing.overload
...
class Box:
    ...
    lo_vect: IntVect3D
    small_end: IntVect3D
    def __add__(self, arg0: IntVect3D) -> Box:
        ...
    ...
    def __init__(self, small: IntVect3D, big: IntVect3D, t: IndexType) -> None:
        ...
    @typing.overload
    def __init__(self, small: typing.Annotated[list[int], pybind11_stubgen.typing_ext.FixedSize(3)], big: typing.Annotated[list[int], pybind11_stubgen.typing_ext.FixedSize(3)]) -> None:
        ...
    @typing.overload
    def __init__(self, small: typing.Annotated[list[int], pybind11_stubgen.typing_ext.FixedSize(3)], big: typing.Annotated[list[int], pybind11_stubgen.typing_ext.FixedSize(3)], t: IndexType) -> None:
        ...
    def __isub__(self, arg0: IntVect3D) -> Box:
        ...
    def __iter__(self) -> typing.Iterator[IntVect3D]:
        ...
    def __repr__(self) -> str:
        ...
    def __sub__(self, arg0: IntVect3D) -> Box:
        ...
...
class FabArray_FArrayBox(FabArrayBase):
    @staticmethod
    def lin_comb(dst: FabArray_FArrayBox, a: float, x: FabArray_FArrayBox, xcomp: int, b: float, y: FabArray_FArrayBox, ycomp: int, dstcomp: int, numcomp: int, nghost: IntVect3D) -> None:
        """
        dst = a*x + b*y
        """
    @staticmethod
    def saxpy(y: FabArray_FArrayBox, a: float, x: FabArray_FArrayBox, xcomp: int, ycomp: int, ncomp: int, nghost: IntVect3D) -> None:
        """
        y += a*x
        """
    @staticmethod
    def xpay(y: FabArray_FArrayBox, a: float, x: FabArray_FArrayBox, xcomp: int, ycomp: int, ncomp: int, nghost: IntVect3D) -> None:
        """
        y = x + a*y
        """
    @typing.overload
    ...
    def sum_boundary(self, scomp: int, ncomp: int, period: Periodicity) -> None:
        ...
        """
    @typing.overload
    def sum_boundary(self, scomp: int, ncomp: int, nghost: IntVect3D, period: Periodicity) -> None:
        """
        Sum values in overlapped cells.  The destination is limited to valid cells.
        """
    @typing.overload
    def sum_boundary(self, scomp: int, ncomp: int, nghost: IntVect3D, dst_nghost: IntVect3D, period: Periodicity) -> None:
        """
        Sum values in overlapped cells.  The destination is limited to valid cells.
        """
    @property
...
class Geometry(CoordSys):
    ...
    def ProbHi(self, dir: int) -> float:
        ...
        """
    @typing.overload
    def ProbHi(self) -> typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(3)]:
        """
    ...
    def ProbLo(self, dir: int) -> float:
        ...
        """
    @typing.overload
    def ProbLo(self) -> typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(3)]:
        """
        Get the list of lo ends of the problem domain
        """
    ...
    def ResetDefaultCoord(self: int) -> None:
        ...
        """
    def ResetDefaultPeriodicity(self: typing.Annotated[list[int], pybind11_stubgen.typing_ext.FixedSize(3)]) -> None:
        """
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def __init__(self, dom: Box, rb: RealBox, coord: int, is_per: typing.Annotated[list[int], pybind11_stubgen.typing_ext.FixedSize(3)]) -> None:
        ...
    def __repr__(self) -> str:
        ...
    def __str__(self) -> str:
    ...
    def data(self) -> GeometryData:
        ...
        """
    def define(self, dom: Box, rb: RealBox, coord: int, is_per: typing.Annotated[list[int], pybind11_stubgen.typing_ext.FixedSize(3)]) -> None:
        """
        Set geometry
        """
    @typing.overload
    ...
    def isPeriodic(self, arg0: int) -> bool:
        ...
        """
    @typing.overload
    def isPeriodic(self) -> typing.Annotated[list[int], pybind11_stubgen.typing_ext.FixedSize(3)]:
        """
    ...
    def refine(self, rr: IntVect3D) -> None:
        ...
    def setPeriodicity(self, period: typing.Annotated[list[int], pybind11_stubgen.typing_ext.FixedSize(3)]) -> typing.Annotated[list[int], pybind11_stubgen.typing_ext.FixedSize(3)]:
        """
...
class GeometryData:
    @typing.overload
    def CellSize(self) -> typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(3)]:
        """
    ...
    def domain(self) -> Box:
        ...
        """
    @property
    def dx(self) -> typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(3)]:
        """
        The cellsize for each coordinate direction.
        """
    @property
    def is_periodic(self) -> typing.Annotated[list[int], pybind11_stubgen.typing_ext.FixedSize(3)]:
        """
...
class MFIter:
    ...
    def tilebox(self) -> Box:
        ...
    @typing.overload
    def tilebox(self, arg0: IntVect3D) -> Box:
        ...
    @typing.overload
...
class MultiFab(FabArray_FArrayBox):
    ...
    @staticmethod
    @typing.overload
    def add(dst: MultiFab, src: MultiFab, srccomp: int, dstcomp: int, numcomp: int, nghost: IntVect3D) -> None:
        """
        Add src to dst including nghost ghost cells.
        The two MultiFabs MUST have the same underlying BoxArray.
        """
    ...
    @staticmethod
    @typing.overload
    def add_product(arg0: MultiFab, arg1: MultiFab, arg2: int, arg3: MultiFab, arg4: int, arg5: int, arg6: int, arg7: IntVect3D) -> None:
        """
        dst += src1*src2
        """
    @staticmethod
    ...
    @staticmethod
    @typing.overload
    def divide(dst: MultiFab, src: MultiFab, srccomp: int, dstcomp: int, numcomp: int, nghost: IntVect3D) -> None:
        """
        Divide dst by src including nghost ghost cells.
        The two MultiFabs MUST have the same underlying BoxArray.
        """
    ...
    @staticmethod
    @typing.overload
    def multiply(dst: MultiFab, src: MultiFab, srccomp: int, dstcomp: int, numcomp: int, nghost: IntVect3D) -> None:
        """
        Multiply dst by src including nghost ghost cells.
        The two MultiFabs MUST have the same underlying BoxArray.
        """
    ...
    @staticmethod
    @typing.overload
    def subtract(dst: MultiFab, src: MultiFab, srccomp: int, dstcomp: int, numcomp: int, nghost: IntVect3D) -> None:
        """
        Subtract src from dst including nghost ghost cells.
        The two MultiFabs MUST have the same underlying BoxArray.
        """
    ...
    @staticmethod
    @typing.overload
    def swap(dst: MultiFab, src: MultiFab, srccomp: int, dstcomp: int, numcomp: int, nghost: IntVect3D) -> None:
        """
        Swap from src to dst including nghost ghost cells.
        The two MultiFabs MUST have the same underlying BoxArray.
        The swap is local.
...
class ParmParse:
    ...
    def addarr(self, arg0: str, arg1: list[str]) -> None:
        ...
    @typing.overload
    def addarr(self, arg0: str, arg1: list[IntVect3D]) -> None:
        ...
    @typing.overload
...
class ParticleContainer_16_4_0_0_arena:
    ...
    def shrink_t_fit(self) -> None:
        ...
    def sort_particles_by_bin(self, arg0: IntVect3D) -> None:
        ...
...
class Particle_16_4:
    ...
    def setPos(self, arg0: RealVect) -> None:
        ...
    @typing.overload
    def setPos(self, arg0: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(3)]) -> None:
        ...
    @typing.overload
...
class Particle_3_0:
    ...
    def get_rdata(self, arg0: int) -> float:
        ...
    @typing.overload
    def get_rdata(self) -> typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(3)]:
        ...
    def id(self) -> int:
        ...
    @typing.overload
    ...
    def set_rdata(self, arg0: int, arg1: float) -> None:
        ...
    @typing.overload
    def set_rdata(self, arg0: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(3)]) -> None:
        ...
class Particle_5_2:
...
class PlotFileData:
    ...
    def boxArray(self, arg0: int) -> BoxArray:
        ...
    def cellSize(self, arg0: int) -> typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(3)]:
        ...
    ...
    def probLo(self) -> typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(3)]:
        ...
    def probSize(self) -> typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(3)]:
        ...
...
class RealBox:
    ...
    def __init__(self, x_lo: float, y_lo: float, z_lo: float, x_hi: float, y_hi: float, z_hi: float) -> None:
        ...
    @typing.overload
    def __init__(self, a_lo: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(3)], a_hi: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(3)]) -> None:
        ...
    @typing.overload
    def __init__(self, bx: Box, dx: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(3)], base: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(3)]) -> None:
        ...
    def __repr__(self) -> str:
        ...
    def __str(self) -> str:
    ...
    def hi(self, arg0: int) -> float:
        ...
        """
    @typing.overload
    def hi(self) -> typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(3)]:
        """
    ...
    def lo(self, arg0: int) -> float:
        ...
        """
    @typing.overload
    def lo(self) -> typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(3)]:
        """
    ...
    def volume(self) -> float:
        ...
    @property
    def xhi(self) -> typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(3)]:
        ...
    @property
    def xlo(self) -> typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(3)]:
        ...
class RealVect:
    __hash__: typing.ClassVar[None] = None
    @staticmethod
...
class Vector_IntVect:
    ...
    def __bool__(self) -> bool:
        ...
        Check whether the list is nonempty
        """
    def __contains__(self, x: IntVect3D) -> bool:
        """
        Return true the container contains ``x``
        """
    @typing.overload
    ...
    def __getitem__(self, s: slice) -> Vector_IntVect:
        ...
        """
    @typing.overload
    def __getitem__(self, arg0: int) -> IntVect3D:
        ...
    @typing.overload
    def __getitem__(self, arg0: int) -> IntVect3D:
        ...
    ...
    def clear(self) -> None:
        ...
        Clear the contents
        """
    def count(self, x: IntVect3D) -> int:
        """
        Return the number of times ``x`` appears in the list
        """
    @typing.overload
    ...
    def extend(self, L: typing.Iterable) -> None:
        ...
        Extend the list by appending all the items in the given list
        """
    def insert(self, i: int, x: IntVect3D) -> None:
        """
        Insert an item at a given position.
        """
    @typing.overload
    def pop(self) -> IntVect3D:
        """
        Remove and return the last item
        """
    @typing.overload
    def pop(self, i: int) -> IntVect3D:
        """
        Remove and return the item at index ``i``
        """
    def remove(self, x: IntVect3D) -> None:
        """
        Remove the first item from the list whose value is x. It is an error if there is no such item.
        """
    def size(self) -> int:

...
class iMultiFab(FabArray_IArrayBox):
    ...
    @overload
    def add(
        self, src: iMultiFab, srccomp: int, comp: int, numcomp: int, nghost: IntVect3D
    ) -> None: ...
    def copymf(
...
class ParIterBase_pureSoA_3_0_polymorphic(MFIter):
    def __init__(
        self, particle_container: ParticleContainer_pureSoA_3_0_polymorphic, level: int
    ) -> None: ...

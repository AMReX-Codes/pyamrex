...
__all__: list[str] = [
    ...
    "ParConstIterBase_pureSoA_2_0_polymorphic",
    "ParConstIterBase_pureSoA_6_0_polymorphic",
    ...
    "ParIterBase_pureSoA_2_0_polymorphic",
    "ParIterBase_pureSoA_6_0_polymorphic",
    ...
    "ParIter_pureSoA_2_0_polymorphic",
    "ParIter_pureSoA_6_0_polymorphic",
    ...
    "StructOfArrays_2_0_idcpu_polymorphic",
...
class Vector_IntVect:
    ...
    @typing.overload
    def __setitem__(
        self, arg0: typing.SupportsInt | typing.SupportsIndex, arg1: IntVect2D
    ) -> None: ...
    @typing.overload
    ...
    def extend(self, L: collections.abc.Iterable) -> None:
        ...
        """
    def insert(
        self, i: typing.SupportsInt | typing.SupportsIndex, x: IntVect2D
    ) -> None:
        """
    ...
    def pop(self) -> IntVect2D:
        ...
        """
    @typing.overload
    def pop(self, i: typing.SupportsInt | typing.SupportsIndex) -> IntVect2D:
        """
...
class Array4_float:
    ...
    @typing.overload
    def __setitem__(
        self, arg0: IntVect2D, arg1: typing.SupportsFloat | typing.SupportsIndex
    ) -> None: ...
    @typing.overload
    def __setitem__(
        self,
...
class Array4_short:
    ...
    @typing.overload
    def __setitem__(
        self, arg0: IntVect2D, arg1: typing.SupportsInt | typing.SupportsIndex
    ) -> None: ...
    @typing.overload
    def __setitem__(
        self,
...
class MFIter:
    ...
    @typing.overload
    def grownnodaltilebox(
        self, int: typing.SupportsInt | typing.SupportsIndex, ng: IntVect2D
    ) -> Box: ...
...
class StructOfArrays_2_0_idcpu_polymorphic:
    ...
    def get_real_data(
        self,
    ) -> typing.Annotated[list[PODVector_real_polymorphic], "FixedSize(2)"]:
        """
        Get access to the particle Real Arrays (only compile-time components)
        """
    @typing.overload
...
class ParticleTileData_pureSoA_2_0:
    ...
    def __init__(self) -> None: ...
    def __setitem__(
        self, arg0: typing.SupportsInt | typing.SupportsIndex, arg1: Particle_2_0
    ) -> None: ...
    def get_super_particle(
        self, arg0: typing.SupportsInt | typing.SupportsIndex
    ) -> Particle_2_0: ...
    def set_super_particle(
        self, arg0: Particle_2_0, arg1: typing.SupportsInt | typing.SupportsIndex
    ) -> None: ...
    @property
...
class ParticleTile_pureSoA_2_0_polymorphic:
    ...
    def shrink_to_fit(self) -> None: ...
    def swap(self, arg0: ParticleTile_pureSoA_2_0_polymorphic) -> None: ...
    @property
    def empty(self) -> bool: ...
    @property
    def num_int_comps(self) -> int: ...
...
class ParIterBase_pureSoA_2_0_polymorphic(MFIter):
    ...
    def __init__(
        self,
        particle_container: ParticleContainer_pureSoA_2_0_polymorphic,
        level: typing.SupportsInt | typing.SupportsIndex,
    ) -> None: ...
    def __iter__(self): ...
    def __next__(self):
...
class ParticleContainer_pureSoA_2_0_polymorphic:
    ...
    num_struct_real: typing.ClassVar[int] = 0
    arena: Arena
    ConstIterator = ParConstIter_pureSoA_2_0_polymorphic
    Iterator = ParIter_pureSoA_2_0_polymorphic
    @typing.overload
    def Define(
        self, arg0: Geometry, arg1: DistributionMapping, arg2: BoxArray
    ) -> None: ...
...
class StructOfArrays_6_0_idcpu_polymorphic:
    ...
    def get_real_data(
        self,
    ) -> typing.Annotated[list[PODVector_real_polymorphic], "FixedSize(6)"]:
        """
        Get access to the particle Real Arrays (only compile-time components)
        """
    @typing.overload
...
class ParticleTileData_pureSoA_6_0:
    ...
    def __init__(self) -> None: ...
    def __setitem__(
        self, arg0: typing.SupportsInt | typing.SupportsIndex, arg1: Particle_6_0
    ) -> None: ...
    def get_super_particle(
        self, arg0: typing.SupportsInt | typing.SupportsIndex
    ) -> Particle_6_0: ...
    def set_super_particle(
        self, arg0: Particle_6_0, arg1: typing.SupportsInt | typing.SupportsIndex
    ) -> None: ...
    @property
    def m_num_runtime_int(self) -> int: ...
    @property
...
class ParticleTile_pureSoA_6_0_polymorphic:
    ...
    def shrink_to_fit(self) -> None: ...
    def swap(self, arg0: ParticleTile_pureSoA_6_0_polymorphic) -> None: ...
    @property
    def empty(self) -> bool: ...
    @property
    def num_int_comps(self) -> int: ...
...
class ParIterBase_pureSoA_6_0_polymorphic(MFIter):
    ...
    def __init__(
        self,
        particle_container: ParticleContainer_pureSoA_6_0_polymorphic,
        level: typing.SupportsInt | typing.SupportsIndex,
    ) -> None: ...
    def __iter__(self): ...
    def __next__(self):
...
class ParticleContainer_pureSoA_6_0_polymorphic:
    ...
    num_struct_real: typing.ClassVar[int] = 0
    arena: Arena
    ConstIterator = ParConstIter_pureSoA_6_0_polymorphic
    Iterator = ParIter_pureSoA_6_0_polymorphic
    @typing.overload
    def Define(
        self, arg0: Geometry, arg1: DistributionMapping, arg2: BoxArray
    ) -> None: ...

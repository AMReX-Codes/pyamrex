...
class Vector_IntVect:
    ...
    @overload
    def __init__(self, arg: Iterable[IntVect2D], /) -> None:
    ...
    def append(self, arg: IntVect2D, /) -> None:
        """Append `arg` to the end of the list."""

    def insert(self, arg0: int, arg1: IntVect2D, /) -> None:
        """Insert object `arg1` before index `arg0`."""

    def pop(self, index: int = -1) -> IntVect2D:
    ...
    def remove(self, arg: IntVect2D, /) -> None:
...
class ParGDBBase:
    ...
    def ref_ratio(self, level: int) -> IntVect2D:

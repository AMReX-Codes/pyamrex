...
__all__: list[str] = [
    ...
    "ParIterBase_pureSoA_1_0_polymorphic",
    "ParIterBase_pureSoA_5_0_polymorphic",
    ...
    "ParIter_pureSoA_1_0_polymorphic",
    "ParIter_pureSoA_5_0_polymorphic",
    "ParallelDescriptor",
    "ParmParse",
    ...
    "ParticleTile_pureSoA_1_0_polymorphic",
    "ParticleTile_pureSoA_5_0_polymorphic",
    "Particle_11_0",
    "Particle_16_4",
    "Particle_1_0",
    "Particle_2_1",
    ...
    "StructOfArrays_1_0_idcpu_polymorphic",
...
class Config:
    amrex_version: typing.ClassVar[str] = "26.02"
    gpu_backend = None
...
class Vector_IntVect:
    ...
    def __getitem__(self, s: slice) -> Vector_IntVect:
        ...
        """
    @typing.overload
    def __getitem__(self, arg0: typing.SupportsInt) -> IntVect1D: ...
    @typing.overload
    def __getitem__(self, arg0: typing.SupportsInt) -> IntVect1D: ...
    @typing.overload
    def __init__(self) -> None: ...
    ...
    @typing.overload
    def __init__(self, arg0: Vector_IntVect) -> None: ...
    def __iter__(self) -> collections.abc.Iterator[IntVect1D]: ...
    def __len__(self) -> int: ...
    ...
    def __repr__(self) -> str: ...
    @typing.overload
    def __setitem__(self, arg0: typing.SupportsInt, arg1: IntVect1D) -> None: ...
    @typing.overload
    ...
    def extend(self, L: collections.abc.Iterable) -> None:
        ...
        Extend the list by appending all the items in the given list
        """
    def insert(self, i: typing.SupportsInt, x: IntVect1D) -> None:
        """
    ...
    def pop(self) -> IntVect1D:
        ...
        """
    @typing.overload
    def pop(self, i: typing.SupportsInt) -> IntVect1D:
        """
...
class Array4_float:
    ...
    def __repr__(self) -> str: ...
    @typing.overload
    def __setitem__(self, arg0: IntVect1D, arg1: typing.SupportsFloat) -> None: ...
    @typing.overload
    def __setitem__(
        self,
        arg0: typing.Annotated[
...
class Array4_short:
    ...
    def __repr__(self) -> str: ...
    @typing.overload
    def __setitem__(self, arg0: IntVect1D, arg1: typing.SupportsInt) -> None: ...
    @typing.overload
    def __setitem__(
        self,
        arg0: typing.Annotated[
...
class BoxArray:
    ...
    @typing.overload
    def coarsenable(self, arg0: IntVect1D, arg1: typing.SupportsInt) -> bool: ...
    @typing.overload
...
class ParmParse:
    ...
    @typing.overload
    def addarr(self, arg0: str, arg1: collections.abc.Sequence[IntVect1D]) -> None: ...
    @typing.overload
...
class RealBox:
    ...
    @typing.overload
    def __init__(
        self, x_lo: typing.SupportsFloat, x_hi: typing.SupportsFloat
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
        a_lo: typing.Annotated[
            collections.abc.Sequence[typing.SupportsFloat], "FixedSize(1)"
        ],
    ...
    def hi(self, arg0: typing.SupportsInt) -> float:
        ...
        """
    @typing.overload
    def hi(self) -> typing.Annotated[list[float], "FixedSize(1)"]:
        """
    ...
    def lo(self, arg0: typing.SupportsInt) -> float:
        ...
        """
    @typing.overload
    def lo(self) -> typing.Annotated[list[float], "FixedSize(1)"]:
        """
    ...
    @property
    def xhi(self) -> typing.Annotated[list[float], "FixedSize(1)"]: ...
    @property
    def xlo(self) -> typing.Annotated[list[float], "FixedSize(1)"]: ...

class GeometryData:
    @typing.overload
    def CellSize(self) -> typing.Annotated[list[float], "FixedSize(1)"]:
        """
    ...
    def Domain(self) -> Box:
        ...
        """
    @typing.overload
    def ProbHi(self) -> typing.Annotated[list[float], "FixedSize(1)"]:
        """
    ...
    def ProbHi(self, arg0: typing.SupportsInt) -> float:
        ...
        """
    @typing.overload
    def ProbLo(self) -> typing.Annotated[list[float], "FixedSize(1)"]:
        """
    ...
    def __repr__(self) -> str: ...
    @typing.overload
    def isPeriodic(self) -> typing.Annotated[list[int], "FixedSize(1)"]:
        """
    ...
    def domain(self) -> Box:
        ...
        """
    @property
    def dx(self) -> typing.Annotated[list[float], "FixedSize(1)"]:
        """
        The cellsize for each coordinate direction.
        """
    @property
    def is_periodic(self) -> typing.Annotated[list[int], "FixedSize(1)"]:
        """
...
class Geometry(CoordSys):
    ...
    def insideRoundOffDomain(self, x: typing.SupportsFloat) -> bool:
        """
    ...
    def isPeriodic(self) -> typing.Annotated[list[int], "FixedSize(1)"]:
        ...
        """
    def outsideRoundOffDomain(self, x: typing.SupportsFloat) -> bool:
        """
    ...
    ) -> typing.Annotated[list[int], "FixedSize(1)"]:
        """
...
class MFIter:
    ...
    @typing.overload
    def grownnodaltilebox(self, int: typing.SupportsInt, ng: IntVect1D) -> Box: ...
...
class FabArray_IArrayBox(FabArrayBase):
    ...
    @typing.overload
    def abs(
        self, comp: typing.SupportsInt, ncomp: typing.SupportsInt, nghost: IntVect1D
    ) -> None: ...
    ...
    def set_val(
        ...
        with the Box region.
        """
    def sum(self, comp: typing.SupportsInt, nghost: IntVect1D, local: bool) -> int:
        """
...
class FabArray_FArrayBox(FabArrayBase):
    ...
    def set_val(
        ...
        with the Box region.
        """
    def sum(self, comp: typing.SupportsInt, nghost: IntVect1D, local: bool) -> float:
        """
        Returns the sum of component "comp"
        """
    @typing.overload
...
class Particle_1_0:
    ...
    def __init__(self, arg0: typing.SupportsFloat) -> None: ...
    @typing.overload
    def __init__(self, arg0: typing.SupportsFloat, *args) -> None: ...
    @typing.overload
    def __init__(self, arg0: typing.SupportsFloat, **kwargs) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def get_rdata(self) -> typing.Annotated[list[float], "FixedSize(1)"]: ...
    def id(self) -> int: ...
    @typing.overload
...
class StructOfArrays_1_0_idcpu_pinned:
    ...
    def get_real_data(
        self,
    ) -> typing.Annotated[list[PODVector_real_pinned], "FixedSize(1)"]:
        """
...
class StructOfArrays_1_0_idcpu_default:
    ...
    def get_real_data(
        self,
    ) -> typing.Annotated[list[PODVector_real_std], "FixedSize(1)"]:
        """
        Get access to the particle Real Arrays (only compile-time components)
        """
    @typing.overload
...
class StructOfArrays_1_0_idcpu_arena:
    ...
    def get_real_data(
        self,
    ) -> typing.Annotated[list[PODVector_real_arena], "FixedSize(1)"]:
        """
        Get access to the particle Real Arrays (only compile-time components)
        """
    @typing.overload
...
class StructOfArrays_1_0_idcpu_polymorphic:
    ...
    def get_int_data(
        self,
    ) -> typing.Annotated[list[PODVector_int_polymorphic], "FixedSize(0)"]:
        """
        Get access to the particle Int Arrays (only compile-time components)
        """
    @typing.overload
    ...
    def get_real_data(
        self,
    ) -> typing.Annotated[list[PODVector_real_polymorphic], "FixedSize(1)"]:
        """
        Get access to the particle Real Arrays (only compile-time components)
        """
    @typing.overload
...
class ParticleTileData_pureSoA_1_0:
    def __getitem__(self, arg0: typing.SupportsInt) -> Particle_1_0: ...
    def __init__(self) -> None: ...
    def __setitem__(self, arg0: typing.SupportsInt, arg1: Particle_1_0) -> None: ...
    def get_super_particle(self, arg0: typing.SupportsInt) -> Particle_1_0: ...
    def set_super_particle(
        self, arg0: Particle_1_0, arg1: typing.SupportsInt
    ) -> None: ...
    @property
...
class ParticleTile_pureSoA_1_0_polymorphic:
    ...
    def set_num_neighbors(self, arg0: typing.SupportsInt) -> None: ...
    def shrink_to_fit(self) -> None: ...
    def swap(self, arg0: ParticleTile_pureSoA_1_0_polymorphic) -> None: ...
    @property
    def empty(self) -> bool: ...
    @property
    def num_int_comps(self) -> int: ...
...
class ParticleInitType_pureSoA_1_0:
    ...
    @property
    def real_array_data(self) -> typing.Annotated[list[float], "FixedSize(1)"]: ...
...
class ParIterBase_pureSoA_1_0_pinned(MFIter):
    ...
    def __init__(
        self,
        particle_container: ParticleContainer_pureSoA_1_0_pinned,
...
class ParticleContainer_pureSoA_1_0_pinned:
    ...
    arena: Arena
    ConstIterator = ParConstIter_pureSoA_1_0_pinned
    ...
    def add_particles_at_level(
        self,
        particles: ParticleTile_pureSoA_1_0_pinned,
        level: typing.SupportsInt,
        ngrow: typing.SupportsInt = 0,
    ) -> None: ...
    @typing.overload
...
class ParIterBase_pureSoA_1_0_default(MFIter):
    ...
    def __init__(
        self,
        particle_container: ParticleContainer_pureSoA_1_0_default,
        level: typing.SupportsInt,
    ) -> None: ...
    def __iter__(self): ...
    def __next__(self):
...
class ParticleContainer_pureSoA_1_0_default:
    ...
    num_struct_real: typing.ClassVar[int] = 0
    arena: Arena
    ConstIterator = ParConstIter_pureSoA_1_0_default
    ...
    def add_particles_at_level(
        self,
        particles: ParticleTile_pureSoA_1_0_default,
        level: typing.SupportsInt,
        ngrow: typing.SupportsInt = 0,
    ) -> None: ...
    @typing.overload
...
class ParIterBase_pureSoA_1_0_arena(MFIter):
    ...
    def __init__(
        self,
        particle_container: ParticleContainer_pureSoA_1_0_arena,
        level: typing.SupportsInt,
    ) -> None: ...
    def __iter__(self): ...
    def __next__(self):
...
class ParticleContainer_pureSoA_1_0_arena:
    ...
    num_struct_real: typing.ClassVar[int] = 0
    arena: Arena
    ConstIterator = ParConstIter_pureSoA_1_0_arena
    ...
    def add_particles_at_level(
        self,
        particles: ParticleTile_pureSoA_1_0_arena,
        level: typing.SupportsInt,
        ngrow: typing.SupportsInt = 0,
    ) -> None: ...
    @typing.overload
...
class ParIterBase_pureSoA_1_0_polymorphic(MFIter):
    ...
    def __init__(
        self,
        particle_container: ParticleContainer_pureSoA_1_0_polymorphic,
        level: typing.SupportsInt,
    ) -> None: ...
    def __iter__(self): ...
    def __next__(self):
...
class ParticleContainer_pureSoA_1_0_polymorphic:
    ...
    num_struct_real: typing.ClassVar[int] = 0
    arena: Arena
    ConstIterator = ParConstIter_pureSoA_1_0_polymorphic
    Iterator = ParIter_pureSoA_1_0_polymorphic
    @typing.overload
    def Define(
        self, arg0: Geometry, arg1: DistributionMapping, arg2: BoxArray
    ) -> None: ...
    ...
    def add_int_comp(self, name: str, communicate: typing.SupportsInt = 1) -> None:
        ...
        """
    def add_particles(
        self, other: ParticleContainer_pureSoA_1_0_polymorphic, local: bool = False
    ) -> None: ...
    def add_particles_at_level(
        self,
        particles: ParticleTile_pureSoA_1_0_polymorphic,
        level: typing.SupportsInt,
        ngrow: typing.SupportsInt = 0,
    ) -> None: ...
    @typing.overload
    ...
    def get_particles(
        self, level: typing.SupportsInt
    ) -> dict[tuple[int, int], ParticleTile_pureSoA_1_0_polymorphic]: ...
    def get_real_comp_index(self, arg0: str) -> int:
        """
        Get the ParticleReal SoA index of a component
        """
...
class StructOfArrays_3_1_polymorphic:
    ...
    def get_int_data(
        self,
    ) -> typing.Annotated[list[PODVector_int_polymorphic], "FixedSize(1)"]:
        """
        Get access to the particle Int Arrays (only compile-time components)
        """
    @typing.overload
    ...
    def get_real_data(
        self,
    ) -> typing.Annotated[list[PODVector_real_polymorphic], "FixedSize(3)"]:
        """
        Get access to the particle Real Arrays (only compile-time components)
        """
    @typing.overload
...
class ParticleContainer_2_1_3_1_polymorphic:
    ...
    num_struct_real: typing.ClassVar[int] = 2
    arena: Arena
    ConstIterator = ParConstIter_2_1_3_1_polymorphic
    Iterator = ParIter_2_1_3_1_polymorphic
    @typing.overload
    def Define(
        self, arg0: Geometry, arg1: DistributionMapping, arg2: BoxArray
    ) -> None: ...
...
class StructOfArrays_0_0_polymorphic:
    ...
    def get_real_data(
        self,
    ) -> typing.Annotated[list[PODVector_real_polymorphic], "FixedSize(0)"]:
        """
        Get access to the particle Real Arrays (only compile-time components)
        """
    @typing.overload
...
class ParticleContainer_16_4_0_0_polymorphic:
    ...
    num_struct_real: typing.ClassVar[int] = 16
    arena: Arena
    ConstIterator = ParConstIter_16_4_0_0_polymorphic
    Iterator = ParIter_16_4_0_0_polymorphic
    @typing.overload
    def Define(
        self, arg0: Geometry, arg1: DistributionMapping, arg2: BoxArray
    ) -> None: ...
...
class StructOfArrays_11_0_idcpu_polymorphic:
    ...
    def get_real_data(
        self,
    ) -> typing.Annotated[list[PODVector_real_polymorphic], "FixedSize(11)"]:
        """
        Get access to the particle Real Arrays (only compile-time components)
        """
    @typing.overload
...
class ParticleContainer_pureSoA_11_0_polymorphic:
    ...
    num_struct_real: typing.ClassVar[int] = 0
    arena: Arena
    ConstIterator = ParConstIter_pureSoA_11_0_polymorphic
    Iterator = ParIter_pureSoA_11_0_polymorphic
    @typing.overload
    def Define(
        self, arg0: Geometry, arg1: DistributionMapping, arg2: BoxArray
    ) -> None: ...
...
class StructOfArrays_5_0_idcpu_polymorphic:
    ...
    def get_real_data(
        self,
    ) -> typing.Annotated[list[PODVector_real_polymorphic], "FixedSize(5)"]:
        """
        Get access to the particle Real Arrays (only compile-time components)
        """
    @typing.overload
...
class ParticleTileData_pureSoA_5_0:
    def __getitem__(self, arg0: typing.SupportsInt) -> Particle_5_0: ...
    def __init__(self) -> None: ...
    def __setitem__(self, arg0: typing.SupportsInt, arg1: Particle_5_0) -> None: ...
    def get_super_particle(self, arg0: typing.SupportsInt) -> Particle_5_0: ...
    def set_super_particle(
        self, arg0: Particle_5_0, arg1: typing.SupportsInt
    ) -> None: ...
    @property
    def m_num_runtime_int(self) -> int: ...
    @property
...
class ParticleTile_pureSoA_5_0_polymorphic:
    ...
    def set_num_neighbors(self, arg0: typing.SupportsInt) -> None: ...
    def shrink_to_fit(self) -> None: ...
    def swap(self, arg0: ParticleTile_pureSoA_5_0_polymorphic) -> None: ...
    @property
    def empty(self) -> bool: ...
    @property
    def num_int_comps(self) -> int: ...
...
class ParticleInitType_pureSoA_5_0:
    ...
    @property
    def real_array_data(self) -> typing.Annotated[list[float], "FixedSize(5)"]: ...
    @real_array_data.setter
    def real_array_data(
        self,
        arg0: typing.Annotated[
...
class ParIterBase_pureSoA_5_0_polymorphic(MFIter):
    ...
    def __init__(
        self,
        particle_container: ParticleContainer_pureSoA_5_0_polymorphic,
        level: typing.SupportsInt,
    ) -> None: ...
    def __iter__(self): ...
    def __next__(self):
...
class ParticleContainer_pureSoA_5_0_polymorphic:
    ...
    num_struct_real: typing.ClassVar[int] = 0
    arena: Arena
    ConstIterator = ParConstIter_pureSoA_5_0_polymorphic
    Iterator = ParIter_pureSoA_5_0_polymorphic
    @typing.overload
    def Define(
        self, arg0: Geometry, arg1: DistributionMapping, arg2: BoxArray
    ) -> None: ...
    ...
    def add_int_comp(self, name: str, communicate: typing.SupportsInt = 1) -> None:
        ...
        """
    def add_particles(
        self, other: ParticleContainer_pureSoA_5_0_polymorphic, local: bool = False
    ) -> None: ...
    def add_particles_at_level(
        self,
        particles: ParticleTile_pureSoA_5_0_polymorphic,
        level: typing.SupportsInt,
        ngrow: typing.SupportsInt = 0,
    ) -> None: ...
    @typing.overload
    ...
    def get_particles(
        self, level: typing.SupportsInt
    ) -> dict[tuple[int, int], ParticleTile_pureSoA_5_0_polymorphic]: ...
    def get_real_comp_index(self, arg0: str) -> int:
        """
        Get the ParticleReal SoA index of a component
        """
...
class AmrInfo:
    ...
    def __init__(self) -> None: ...
    def __repr__(self) -> str: ...
    def blocking_factor(self, arg0: typing.SupportsInt) -> IntVect1D: ...
    def max_grid_size(self, arg0: typing.SupportsInt) -> IntVect1D: ...
    def n_error_buf(self, arg0: typing.SupportsInt) -> IntVect1D: ...
    def ref_ratio(self, arg0: typing.SupportsInt) -> IntVect1D: ...
    @property
...
class PlotFileData:
    ...
    ) -> typing.Annotated[list[float], "FixedSize(1)"]: ...
    ...
    def nComp(self) -> int: ...
    def nGrowVect(self, arg0: typing.SupportsInt) -> IntVect1D: ...
    def probDomain(self, arg0: typing.SupportsInt) -> Box: ...
    def probHi(self) -> typing.Annotated[list[float], "FixedSize(1)"]: ...
    def probLo(self) -> typing.Annotated[list[float], "FixedSize(1)"]: ...
    def probSize(self) -> typing.Annotated[list[float], "FixedSize(1)"]: ...

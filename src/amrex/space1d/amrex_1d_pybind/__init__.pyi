...
class FabArray_FArrayBox(FabArrayBase):
    ...
    @typing.overload
    def fill_boundary(self, cross: bool = ...) -> None: ...
    @typing.overload
    def fill_boundary(self, period: Periodicity, cross: bool = ...) -> None: ...
    @typing.overload
    def fill_boundary(
        self, nghost: IntVect, period: Periodicity, cross: bool = ...
    ) -> None: ...
    @typing.overload
    def fill_boundary(self, scomp: int, ncomp: int, cross: bool = ...) -> None: ...
    @typing.overload
    def fill_boundary(
        self, scomp: int, ncomp: int, period: Periodicity, cross: bool = ...
    ) -> None: ...
    @typing.overload
    def fill_boundary(
        self,
...
class MFIter:
    ...
    def fabbox(self) -> Box: ...
    @typing.overload
    def grownnodaltilebox(self, int: int = ..., ng: int = ...) -> Box: ...
    @typing.overload
    def grownnodaltilebox(self, int: int, ng: IntVect) -> Box: ...
    def growntilebox(self, ng: IntVect = ...) -> Box: ...
    def nodaltilebox(self, dir: int = ...) -> Box: ...
    @typing.overload
...
class MultiFab(FabArray_FArrayBox):
    ...
    @typing.overload
    def max(self, comp: int = ..., nghost: int = ..., local: bool = ...) -> float:
        """
        Returns the maximum value of the specfied component of the MultiFab.
        """
    @typing.overload
    def max(
        self, region: Box, comp: int = ..., nghost: int = ..., local: bool = ...
    ) -> float:
        """
    ...
    @typing.overload
    def min(self, comp: int = ..., nghost: int = ..., local: bool = ...) -> float:
        """
    ...
    def sum(self, comp: int = ..., local: bool = ...) -> float:
        """
        Returns the sum of component 'comp' over the MultiFab -- no ghost cells are included.
        """
    def sum_unique(
        self, comp: int = ..., local: bool = ..., period: Periodicity = ...
    ) -> float:
        """
...
class ParmParse:
    ...
    def get_bool(self, name: str, ival: int = ...) -> bool:
        """
        parses input values
        """
    def get_int(self, name: str, ival: int = ...) -> int:
        """
        parses input values
        """
    def get_real(self, name: str, ival: int = ...) -> float:
        """
        parses input values
        """
    def query_int(self, name: str, ival: int = ...) -> tuple[bool, int]:
        """
...
class ParticleContainer_0_0_4_0_arena:
    ...
    def NumberOfParticlesAtLevel(
        self, level: int, only_valid: bool = ..., only_local: bool = ...
    ) -> int: ...
    def NumberOfParticlesInGrid(
        self, level: int, only_valid: bool = ..., only_local: bool = ...
    ) -> Vector_Long: ...
    def OK(self, lev_min: int = ..., lev_max: int = ..., nGrow: int = ...) -> bool: ...
    ...
    def TotalNumberOfParticles(
        self, only_valid: bool = ..., only_local: bool = ...
    ) -> int: ...
    @typing.overload
    def __init__(self) -> None: ...
    @typing.overload
...
class RealBox:
    ...
    def __str(self) -> str: ...
    @typing.overload
    def contains(self, rb: XDim3, eps: float = ...) -> bool:
        """
        Determine if RealBox contains ``pt``, within tolerance ``eps``
        """
    @typing.overload
    def contains(self, rb: RealVect, eps: float = ...) -> bool:
        """
        Determine if RealBox contains ``pt``, within tolerance ``eps``
        """
    @typing.overload
    def contains(self, rb: RealBox, eps: float = ...) -> bool:
        """
        Determine if RealBox contains another RealBox, within tolerance ``eps``
        """
    @typing.overload
    def contains(self, rb: list[float], eps: float = ...) -> bool:
        """
        Determine if RealBox contains ``pt``, within tolerance ``eps``
        """
    @typing.overload
...
def AlmostEqual(rb1: RealBox, rb2: RealBox, eps: float = ...) -> bool:
    """
...
def concatenate(root: str, num: int, mindigits: int = ...) -> str:
    """
